...
\multicolumn{1}{|c|}{\multirow{2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Thread\\ Affinity\end{tabular}}}} & Inherit & CI & SI & NI &  \\ \cline{2-5}
\multicolumn{1}{|c|}{} & Explicit per Core & CE & SE & NE &  \\ \cline{1-5}
\end{tabular}
\end{table}
...
%minipage kmeans Java CE vs NE | Java vs C
\begin{figure*}[!htb]
    \begin{minipage}{0.49\textwidth}
        \centering
